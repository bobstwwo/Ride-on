<template>
  <div class="hello">
    <yandex-map zoom="4" style="width: 100%; max-width: 100%; height: 98vh" :coords="coords">
      <ymap-marker
...
export default {
    ...
    return {
      ...
      surfaces: [
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: '1-я Останкинская ул., пересечение с ул. Академика Королева (съезд с пр-та Мира) (A) из центра ',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Варшавское шоссе, н-в д.52, 500 м. после развилки с Каширским шоссе (A) в центр',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Киевское шоссе, справа при движении из Москвы, поворот на Хованское (A)',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Ленинградское ш., д. 20, корпус 1., пересечение с ул. Адмирала Макарова (B) в центр',
          side: 'B',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Ленинградское ш., д. 73, (съезд с МКАД, у 1 оп. на въезде) (A) в центр',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Мира проспект, 81 Б стр.1 (Крестовский путепровод) (A) в центр',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'МКАД, 1,720 км., между Энтузиастов ш. – Рязанский пр. (A) внутреннее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'МКАД, 23,20 км., между Волгоградский пр. – Каширское ш. (A) внутреннее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'МКАД, 27,85 км., между Каширское ш. – Варшавское ш. (A) внутренее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'МКАД, 43,45 км., между Ленинский пр. – Профсоюзная ул. (A) внешнее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'МКАД, 60,88 км., между Рублевское ш. – Новорижское ш. (A) внутреннее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'МКАД, 87,700 км., между Алтуфьевское ш. – Осташковское ш. (A) внутреннее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Нижегородская улица, н-в д.50, пересечение с ТТК (B) в центр',
          side: 'B',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Рублевское шоссе, в районе дома 10 по  ул. Ивана Франко (A) в центр',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'ТТК, Русаковская эстакада с ул. Гаврикова, д. 11 с.2 (A) внешнее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'ТТК, Съезд с Кутузовского проспекта на ТТК, 450 м.,(B) внешнее',
          side: 'B',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'ТТК, Трофимова ул., 2-й Кожуховский пр-д, д.21 (A) внутреннее',
          side: 'A',
        ...
        },
        {
          ...
          city: 'Moscow',
          type: 'DSS',
          address: 'Ярославское шоссе, н-в д.2, пр. Серебрякова пер. с Летчика Бабушкина ул. (A) в центр',
          side: 'A',
  ...
  watch: {
    selectedSurfaces() {
      this.makeSurfaceSelected(this.selectedSurfaces[this.selectedSurfaces.length - 1].SURFACEID);
    },
  },
  methods: {
