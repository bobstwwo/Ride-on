  ...
  <div class="container">
    ...
    <div class="steps">
      ...
      <div class="step-3 df">
        ...
        <div :class="{ white: this.position === 3 ? true : false }" class="step-info text">Правила сервиса</div>
      </div>
      <div class="step-4 df">
        <div :class="{ grey: this.position === 4 ? true : false }" class="step-info numb">04</div>
        <div class="step-line last-line"><div class="step-line-circ"></div></div>
...
import { animateShow, animateHide, animateSteps2 } from '@/main/common';
    ...
    nextBtn() {
      if (this.componentName === 'InfoForm') {
        ...
        if (this.phone !== '') {
          ...
          this.warningTitle = 'Поле номера телефона - обязательно!';
          this.showWarning = true;
        }
