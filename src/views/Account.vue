<template>
  <div class="block">
    <div class="container">
      <div class="sidebar">
        <span class="logo"><span>Ride-on</span></span>
        <a class="logo-expand" href="#">Ride-on</a>
        <div class="side-wrapper">
          <div class="side-title">МЕНЮ</div>
          <div class="side-menu">
            <div
              @click="$router.push({ name: 'adding' })"
              :class="{ 'is-active': $router.currentRoute.name === 'adding' }"
              class="sidebar-link"
            >
            ...
            <div
              ...
              :class="{ 'is-active': $router.currentRoute.name === 'trips' }"
              class="sidebar-link"
            >
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path
            ...
            <div
              ...
              :class="{ 'is-active': $router.currentRoute.name === 'find' }"
              class="sidebar-link"
            >
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path
            ...
            <div
              :class="{ 'is-active': $router.currentRoute.name === 'profile' }"
        ...
        <!-- <div class="side-wrapper">
          <div class="side-title">РАЗНОЕ</div>
          <div class="side-menu">
            <div
              @click="$router.push({ name: 'profile' })"
              :class="{ 'is-active': $router.currentRoute.name === 'profile' }"
      ...
      <div class="right">
        <div class="header">
          ...
          <div class="user-settings">
            ...
            <div v-if="this.user" @click="close()" class="user-name">{{ this.user.name }}</div>
            ...
            <div v-if="isSelectBox" class="select-box">
              <span @click="goProfile()">Мой профиль</span>
